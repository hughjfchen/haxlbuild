...
if [ -e ${SCRIPT_ABS_PATH}/../../result ]; then
  [[ -e ${SCRIPT_ABS_PATH}/../../haxlbuild.tar.gz ]] && rm -fr ${CRIPT_ABS_PATH}/../../haxlbuild.tar.gz
  tar zPcf ${SCRIPT_ABS_PATH}/../../haxlbuild.tar.gz $(nix-store --query --requisites ${SCRIPT_ABS_PATH}/../../result)
else
