...
defaultPlatformProject.pkgs.lib.mapAttrs (_: pkgs: rec {
  ...
  haxlbuild = import ./default.nix { nativePkgs = pkgs;
                                     customModules = [ { packages.haxlbuild.dontStrip = false; } ] ++ (if pkgs.stdenv.hostPlatform.isMusl then 
                                                        [
                                                          ...
                                                          { packages.haxlbuild.configureFlags = 
                                                            [
